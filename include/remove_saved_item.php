...
<?php
	...
	$select_product = mysqli_query($config,"select * from saved_items where customer_id ='$customer_id' ");
	...
	$delete_saved_item = mysqli_query($config,"delete from saved_items where customer_id='$customer_id' and product_id='$product_id' ");
?>
